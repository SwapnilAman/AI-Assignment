...
public class AStarSolver {
	...
	public static void main(String[] ārgs) {
     ...
     new AStarSolver(cost ,n ,0).solve(cost,n,0);
	}
	...
	public AStarSolver(int [][] cost, int numOfCities, int startCity){
        ...
        void solve(int [][] cost, int numOfCities, int startCity){//i remove private
		int numOfVisited = 1;
	 ...
	 void calPath(int cost[][]){//I removed private
